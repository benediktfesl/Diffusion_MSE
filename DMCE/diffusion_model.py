...
class Trainer(object):
    def __init__(self,
                 ...
                 *,
                 ...
                 use_ray: bool = False,
                 complex_data: bool = True,
                 num_min_epochs: int = 1_000,
                 num_epochs_no_improve: int = 100,
                 ):
        """
...
class Tester(object):
    ...
    def _test_nmse(self) -> dict:
        ...
        snr_db_range = torch.arange(-30, 45, 5, dtype=torch.float32, device=self.device)
        ...
        for snr in tqdm(iterable=snr_range):
            ...
            for data_batch in self.dataloader:
                ...
                x_hat.append(self.model.generate_estimate(y.to(device=self.device), snr, return_all_timesteps=self.return_all_timesteps))
...
class Early_stopping:
    def __init__(self, min_epochs: int=1_000, num_epochs_no_improve: int=100):
